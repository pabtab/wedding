...
export const Location = () => {
  ...
  return (
    <section className='w-full text-center'>
      <h1 className='text-olivergreen lg:my-10'>Lugar</h1>
      <div className='lg:flex lg:justify-around'>
        <div className='mb-8 lg:mb-0 flex flex-col items-center'>
          <h2 className='flex items-center justify-center text-olivergreen'>
            <BiChurch size={iconSize} className='text-olivergreen lg:mb-5' />
            Ceremonia
          </h2>
          <iframe
        ...
        <div className='mb-8 lg:mb-0 flex flex-col items-center'>
          <h2 className='flex items-center justify-center text-olivergreen'>
            <PiWineBold size={iconSize} className='text-olivergreen lg:mb-5' />
            Recepción
          </h2>
          <iframe
